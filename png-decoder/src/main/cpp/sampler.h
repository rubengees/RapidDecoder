...
public:
    opaque_sampler(int width, int sampled_width, unsigned int sample_size, bool filter,
...
public:
    sampler(int width, int sampled_width, unsigned int sample_size, bool filter,
            const pixel_format &format);
